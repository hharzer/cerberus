...
def test_nested_error_paths(validator):
    ...
    assert len(set['a_list']['itemsrules'].errors) == 1
    assert len(set['a_list']['itemsrules']['type'].errors) == 1
    assert len(set['a_list']['itemsrules']['oneof'][0]['regex'].errors) == 1
    assert len(set['a_list']['itemsrules']['oneof'][1]['regex'].errors) == 1
    ...
    assert set['a_list']['itemsrules']['oneof'].errors[0] == ref_err6
    assert set['a_list']['itemsrules']['oneof'][0]['regex'].errors[0] == ref_err7
    assert set['a_list']['itemsrules']['oneof'][1]['regex'].errors[0] == ref_err8
    assert set['a_list']['itemsrules']['type'].errors[0] == ref_err5
